...
- 后端：`develop` @ `a45ee24`（定妆落盘重开可读；功能头 `7d4138b`）。
...
- 本轮：2026-09-17 独立核对。mock 主链已在 `http://127.0.0.1:5197/` 走通广场作品→全屏→作者主页→评论叠层、游客收藏绑定、我的作品未通过入口。定妆落盘换仓储实例可读已合 `echo@a45ee24`。真万相重开未见（本机无服务提供者编码）。夹具红灯仍锁。漫画/视频、真短信、打 Tag 仍后置。不签完整私域 PASS。
...
- QA核查：2026-09-17 独立复验了最新 mock 主链与定妆落盘重开可读；真库/真出图本次未起。不签完整私域 PASS。
