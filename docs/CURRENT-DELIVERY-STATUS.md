...
| 2 | phone-account-resolution | 固定9999开发增量QA PASS，真实新号绑定，HTTP已有号切换通过；切号不迁资料已由专项测试锁住 | 唤醒入口 I09 进行中；合入等做完再提；阿里云后置 |
...
| I09 | 切号后受控唤醒旧匿名会话 | 代码已交，未合 develop。`echo@6d2b1b3` / `echo-client@5c4efde`。mock 已走切号/我/唤醒；修钥匙后未重跑；真 PG 未接 |
