...
| I08 | 前后端功能分支合入develop及整版标签 | 已合 develop，未打 Tag。后端 `echo@67d7fc1`，前端 `echo-client@f6bc539`。夹具红灯不在公共区做 |
...
- schema：2026091403；开发API 18080、页面5180 他人占用不碰。本轮真出图曾走独立 18081/5179/5433，现已停掉。短信固定9999。
