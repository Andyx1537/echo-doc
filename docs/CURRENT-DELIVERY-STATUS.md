...
更新时间：2026-09-15。回到用户确认的七个最小单元，不以局部测试代替整版完成。
...
| I08 | 前后端功能分支合入develop及整版标签 | 已合 develop，未打 Tag。后端 `echo@67d7fc1`，前端 `echo-client@78da741`。夹具红灯不在公共区做 |
...
- 本轮：游客点「我的收藏」不再把 1002 吞成空页；mock 5177 已走出绑定提示，绑定后才是「还没有收下什么」。定妆真出图仍以前一提交为准。漫画/视频、真短信、打 Tag 仍后置。
